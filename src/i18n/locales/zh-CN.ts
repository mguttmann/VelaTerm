...
const zhCN: typeof en = {
  ...
  "launch.splitReview": "确认执行任务",
  "launch.splitReviewHint": "由同一个规划会话接收汇报并逐项验收。确认后才会启动执行会话。",
  "launch.splitConfirmed": "这些任务已经确认。",
  "launch.splitClosed": "此方案已不再等待确认。",
  "launch.splitRetry": "重试尚未送达的任务消息",
  "launch.splitSharedDirectory": "所有执行会话使用规划会话的工作目录；启用工作树时共同使用该工作树。",
  "launch.createIn": "创建位置",
  "launch.workingDirectory": "工作目录路径",
  "launch.createAndStart": "创建并启动",
  "launch.planExecuteTaskHint": "说明任务目标、要求和验收标准，供规划会话制定方案。",
  "launch.planExecuteResult": "先启动规划会话，再由规划会话创建执行会话。",
  "launch.planExecuteWorktreeHint": "新工作树基于当前提交创建，不包含未提交的修改；创建失败时不启动对应会话。",
  "launch.workflowDirectorySharedHint": "规划会话和所有执行会话共用一个新目录和分支。",
  "launch.workflowDirectoryEachHint": "规划会话和每个执行会话分别使用独立的工作树和分支。",
  "launch.planTitle": "规划与验收",
  "launch.execTitle": "执行",
  "launch.planExecuteIntro": "新建规划会话，负责制定方案、验收结果，并向执行会话反馈修改要求。",
  "chat.origin.plan": "规划",
  "chat.origin.exec": "执行",

  // Project code intelligence and knowledge entry associations.
  "knowledge.callers": "调用者",
  "knowledge.callees": "被调用者",
  "knowledge.explore": "代码探索",
  "knowledge.exploreHint": "描述功能或调用流程，或输入文件、符号名称…",
  "knowledge.impact": "影响分析",
  "knowledge.path": "调用路径",
  "knowledge.target": "搜索目标符号…",
  "knowledge.depth": "遍历深度",
  "knowledge.noPath": "索引中未找到有向调用路径。",
  "knowledge.watching": "自动同步已启用",
  "knowledge.onDemand": "查询前同步",
  "knowledge.overview": "概览",
  "knowledge.uncertain": "推断关系",
  "knowledge.kind": "符号类型",
  "knowledge.language": "语言",
  "knowledge.results": "结果",
  "knowledge.resultLarge": "结果过大，无法显示。请缩小查询范围或降低遍历深度。",
  "knowledge.queryFailed": "代码查询失败，请重试或同步索引。",
  "knowledge.liveHelp": "查询进程运行期间会同步文件变化；进程闲置退出后，下次查询会先补齐变更。",
  "knowledge.startHelp": "启用索引后，即可搜索代码、追踪调用和分析变更影响。分析在后端执行，无需调用 AI 模型。",
  ...
  "knowledge.selectSymbol": "选择一个符号，查看源码、关联关系和相关知识条目。",
  "knowledge.source": "源码",
  ...
  "knowledge.linkMemory": "关联知识条目",
  "knowledge.chooseMemory": "选择知识条目",
  "knowledge.noLinks": "暂无代码关联。可在符号详情中关联知识条目。",
  "knowledge.inspect": "核对代码与条目",
  ...
  "knowledge.reviewHelp": "请将此条目与所显示的代码进行核对。确认后仅记录当前文件版本，不修改条目正文。",
  "knowledge.confirmReview": "确认已复核",
  "knowledge.agentHint": "智能体可在此工作目录运行 vkb search \"主题\"。查询会同步已启用的索引，并分别返回代码和知识条目。",
  "knowledge.busy": "索引任务正在运行。可以关闭此页面，或停用索引以停止任务。",
  "knowledge.disabledHelp": "启用此目录的索引后即可查询代码。停用会保留索引和知识条目关联。",
  "knowledge.conflict": "代码或条目已发生变化。请重新加载后再保存关联。",
  ...
  "memory.hierarchy": "项目与会话",
  "memory.up": "返回上一级",
  "memory.manualGroup": "手动创建",
  "memory.legacyGroup": "历史合并条目",
  "memory.unknownProject": "来源项目未知",
  "nb.addLink": "插入链接",
  "nb.attach": "添加附件",
  "nb.browse": "浏览",
  "nb.chooseNote": "从一篇笔记开始",
  "nb.closeHint": "仅从列表中移除此知识库，磁盘上的文件会保留。",
  "nb.closeVault": "关闭知识库",
  "nb.conflict": "文件已被外部修改，当前草稿已保留。请重新读取文件，或将草稿另存为新笔记。",
  "nb.copyTo": "复制到本地知识库",
  "nb.createVault": "新建知识库",
  "nb.destination": "目标路径",
  "nb.download": "下载",
  "nb.downloadHint": "下载此附件后，可使用其他应用打开。",
  "nb.empty": "打开一个文件夹开始记录，或新建知识库。",
  "nb.emptyImport": "所选内容中没有可导入的文件。",
  "nb.emptyNotes": "笔记以 Markdown 文件保存。",
  "nb.emptyOutline": "文档标题会显示在这里。",
  "nb.emptyTrash": "回收站为空。",
  "nb.error": "无法访问知识库，请检查连接和文件夹后重试。",
  "nb.exists": "目标已存在，请更换名称或文件夹。",
  "nb.favorites": "收藏",
  "nb.files": "文件",
  "nb.folder": "文件夹",
  "nb.generatedHint": "保存由会话整理出的知识，并保留来源和修订历史。",
  "nb.homeHint": "浏览会话知识库和本地知识库。",
  "nb.homeSearch": "搜索会话知识与本地笔记…",
  "nb.loadMore": "加载更多",
  "nb.import": "导入",
  "nb.importFiles": "选择文件",
  "nb.importFolder": "选择文件夹",
  "nb.importHint": "文件将复制到所选目录，不覆盖已有文件；隐藏的配置目录会被跳过。",
  "nb.imported": "已导入",
  "nb.imports": "导入记录",
  "nb.importsEmpty": "还没有导入记录。",
  "nb.importRoot": "知识库根目录",
  "nb.importBusy": "该知识库已有导入正在进行。",
  "nb.importDelete": "删除记录",
  "nb.importDeleteConfirm": "删除这条导入记录？已导入的文件不会被删除。",
  "nb.importDone": "导入完成",
  "nb.importDuration": (seconds: string) => `${seconds} 秒`,
  "nb.importFailed": "导入失败",
  "nb.importFilePending": "未导入",
  "nb.importHideFiles": "收起文件清单",
  "nb.importInterruptedHint": "导入在完成前中断了。",
  "nb.importProgress": (done: string, total: string) => `${done} / ${total} 个文件`,
  "nb.importShowFiles": (count: string) => `文件清单（${count}）`,
  "nb.importSkipHidden": "隐藏文件或目录",
  "nb.importStatusCancelled": "已取消",
  "nb.importStatusCompleted": "已完成",
  "nb.importStatusFailed": "失败",
  "nb.importStatusInterrupted": "已中断",
  "nb.importStatusRunning": "正在导入",
  "nb.incomplete": "操作未能完成，请检查文件后重试。",
  "nb.info": "笔记信息",
  "nb.invalid": "名称或路径无效。",
  "nb.links": "引用的笔记",
  "nb.local": "本地文件",
  "nb.localVaults": "本地知识库",
  "nb.move": "重命名或移动",
  "nb.moveHint": "填写相对于知识库根目录的路径。移动文件或文件夹时，会更新已有的笔记链接。",
  "nb.name": "名称",
  "nb.newFolder": "新建文件夹",
  "nb.newNote": "新建笔记",
  "nb.noLinks": "暂无关联笔记。",
  ...
  "nb.outline": "大纲",
  "nb.quickOpen": "快速打开",
  "nb.readOnly": "此文件无法作为 UTF-8 Markdown 笔记编辑。",
  "nb.recent": "最近笔记",
  "nb.restore": "恢复",
  "nb.reload": "重新读取文件",
  "nb.root": "文件夹路径",
  "nb.rootHint": "选择当前连接计算机上的文件夹，已有 Markdown 文件和附件会保留在原处。",
  "nb.saveCopy": "另存为新笔记",
  "nb.saved": "已保存到文件",
  "nb.saving": "正在保存…",
  "nb.search": "搜索笔记…",
  "nb.searchAllVaults": "全部知识库",
  "nb.searchCount": (count: string) => `${count} 条结果`,
  "nb.searchEmpty": "没有匹配的笔记。",
  "nb.searchEmptyAll": "没有匹配的内容。",
  "nb.searchFuzzy": "没有精确匹配，以下为近似结果。",
  "nb.searchLine": (line: string) => `第 ${line} 行`,
  "nb.searchMatches": (count: string) => `${count} 处命中`,
  "nb.searchMore": "只列出前面的结果，缩小关键词可看到其余命中。",
  "nb.searchRelated": "相关笔记",
  "nb.searchResults": "搜索结果",
  "nb.searchScope": "搜索范围",
  "nb.searchThisVault": "当前知识库",
  "nb.skipped": "已跳过",
  "nb.split": "分栏",
  "nb.tooLarge": "文件或所选内容超出知识库限制。",
  "nb.trash": "回收站",
  "nb.trashHint": "将此内容移入知识库回收站，之后可以恢复。",
  "nb.unsaved": "尚未保存",
  "nb.vaults": "知识库",
  "nb.view": "视图模式",
  "nb.welcome": "个人知识库",
  "nb.welcomeText": "自由记录、连接想法，用普通本地文件保存笔记。打开已有 Markdown 文件夹，或将资料导入新的知识库。",
  "memory.globalMemory": "会话知识库",
  "memory.collections": "已归档会话",
  "memory.collectionConversation": "对话",
  "memory.collectionEmptyEntries": "这段对话还没有知识条目。",
  "memory.title": "知识库",
  "memory.add": "整理到会话知识库",
  "memory.intro": "按项目和会话组织知识。条目生成后独立保存，不随来源变化自动更新，可手动编辑。",
  "memory.entries": "知识条目",
  "memory.emptyJobs": "暂无整理记录。",
  "memory.jobs": "整理记录",
  "memory.search": "搜索条目标题与正文…",
  "memory.empty": "暂无匹配的条目。可从会话中生成知识条目，或手动新建条目。",
  ...
  "memory.related": "关联条目",
  "memory.backlinks": "反向引用",
  "memory.sources": "来源",
  "memory.history": "修订历史",
  "memory.restore": "恢复此版本",
  "memory.restoreConfirm": "将此修订恢复为新版本？当前版本仍会保留在历史中。",
  "memory.deleteConfirm": "删除此条目及其修订历史？来源会话不受影响。",
  "memory.groupDeleteConfirm": (count: string) => `删除该组内的全部 ${count} 条知识条目？项目或会话本身保留。`,
  "memory.export": "导出 Markdown",
  "memory.selectAgent": "智能体",
  "memory.model": "模型（可选）",
  "memory.modelHint": "留空时使用智能体已配置的模型。",
  "memory.compile": "整理并保存",
  "memory.compileHelp": "所选智能体会整理此会话。再次生成将覆盖该会话已有的生成条目，包括手动修改。会话文本将通过你配置的智能体发送给模型。",
  "memory.unavailable": "未安装或未配置",
  "memory.allTags": "全部标签",
  "memory.updated": "最近更新",
  "memory.titleSort": "按标题排序",
  "memory.sourceNote": "此快照保留整理时使用的会话文本；原会话删除后仍可查阅。",
  "memory.noKnowledge": "本次未提取到可复用知识，该会话已有的生成条目已清空。",
  "memory.queued": "等待开始",
  "memory.cancelling": "正在取消",
  "memory.schedulingHint": "不同会话可并行整理。再次提交会取消本会话尚未完成的整理，并由新任务替代。",
  "memory.waitingHint": "等待本会话的上一项整理停止后，将自动开始。",
  "memory.running": "进行中",
  ...
  "memory.conflict": "操作期间此条目已发生变更。请重新加载后再试；本次修改尚未保存。",
  "memory.duplicate": "已存在同名条目，请打开该条目合并内容。",
  "memory.notFound": "此条目、来源或任务已不存在。",
  "memory.noTranscript": "此会话暂无可读取的对话内容。",
  "memory.agentUnavailable": "所选智能体不可用，请在设置中检查其可执行文件路径。",
  "memory.invalid": "部分字段或链接无效，请检查标题、正文及关联条目。",
  ...
  "memory.tooLarge": "来源、上下文或输出超出支持的大小，未截断内容，也未保存条目。",
  "memory.invalidOutput": "智能体返回的结构化数据无效，未保存条目。请重试或更换智能体。",
  "memory.loadError": "无法加载知识库数据，请检查连接后重试。",
  ...
  "settings.agentDefaultsTitle": "新会话默认设置",
  "settings.referSummaryTitle": "会话引用上下文",
  "settings.referSummaryMode": "上下文方式",
  "settings.referSummaryFull": "使用全文",
  "settings.referSummaryFirst": "先总结",
  "settings.referSummaryAgent": "总结智能体",
  "settings.referSummaryHint":
    "默认情况下，vrefer --ask 会将完整记录交给回答智能体。启用“先总结”后，将统一使用此处选择的智能体、模型和思考程度进行压缩；最终回答还会结合相关的原文搜索片段。",
  ...
  "settings.agentDefaultView": "默认视图",
  ...
  "spawn.title": "启动子会话",
  "spawn.fromSession": "发起会话",
  "spawn.promptLabel": "任务说明",
  "spawn.agentLabel": "会话类型",
  "spawn.worktreeLabel": "独立工作树",
  "spawn.modelLabel": "模型",
  "spawn.effortLabel": "推理强度",
  "spawn.modelDefault": "使用智能体默认设置",
  "spawn.modelLoading": "正在获取模型…",
  "spawn.modelListUnavailable": "暂无模型列表，可手动输入模型标识。",
  "spawn.launch": "启动子会话",
  "spawn.remaining": (n: number) => `另有 ${n} 项待确认`,
  "spawn.notifyTitle": "子会话启动待确认",
  "spawn.requestUnavailable": "此请求缺少标识。请重新连接以恢复请求，再进行确认或取消。",
  "spawn.deliveryUncertain": "初始任务可能已经发送。请先打开已有会话检查状态，再继续操作。系统不会自动重发。",
  "spawn.confirmedChoices": "此启动请求已经确认。重试将沿用同一会话和启动设置。",
  "orch.title": "批量启动子会话",
  "orch.notifyTitle": "批量启动待确认",
  "orch.coordinatorName": "会话状态",
  "orch.sharedSettings": "公共设置",
  "orch.agentLabel": "智能体",
  "orch.modelLabel": "模型",
  "orch.effortLabel": "推理强度",
  "orch.nameLabel": "会话名称",
  "orch.promptLabel": "任务说明",
  "orch.worktreeLabel": "Git 工作树",
  "orch.worktreeNone": "使用当前目录",
  "orch.worktreeShared": "共用一个工作树",
  "orch.worktreeEach": "各用一个工作树",
  "orch.follow": "使用公共设置",
  "orch.overridden": "单独设置",
  "orch.remove": "移除任务",
  "orch.launch": (n: number) => `启动 ${n} 个子会话`,
  "orch.modelPlaceholder": "使用智能体默认设置",
  "orch.effortPlaceholder": "使用智能体默认设置",
  "launch.terminalHint": "普通终端会打开工作目录，不会自动执行任务说明中的内容。",
  "launch.optionsError": "无法加载启动选项，请重试后再启动。",
  "launch.singleIntro": "启动前，请检查子会话的任务和运行设置。",
  "launch.taskHint": "这些内容将作为子会话收到的第一条消息。",
  "launch.runtime": "运行设置",
  "launch.directory": "工作目录",
  "launch.directoryCurrentHint": "直接在原目录中修改文件。",
  "launch.directorySharedHint": "所有子会话在同一个新目录和分支中工作。",
  "launch.directoryEachHint": "每个子会话使用各自的目录和分支。",
  "launch.worktreeHint": "工作树基于当前提交创建，不包含未提交的改动；创建失败时会使用原目录。",
  "launch.singleResult": "子会话将显示在左栏的发起会话下。",
  "launch.startError": "启动失败，请检查设置后重试。",
  "launch.starting": "正在启动…",
  "launch.batchIntro": "先检查公共设置，再逐项选择任务并编辑说明。",
  "launch.sessionCount": (n: number) => `${n} 个子会话`,
  "launch.batchName": "任务组名称",
  "launch.sharedHint": "未单独设置的子会话将使用这些选项。",
  "launch.tasks": "任务列表",
  "launch.incomplete": "待补充",
  "launch.undoRemove": "撤销移除",
  "launch.taskNumber": (n: number) => `任务 ${n}`,
  "launch.taskSettings": "此会话的设置",
  "launch.taskAgent": "此会话的智能体",
  "launch.sharedDirectoryLocked": "本次任务组中的所有子会话将共用一个工作树。",
  "launch.resetSettings": "恢复公共设置",
  "launch.monitorHint": "启动后会打开“会话状态”终端，显示各会话正在工作还是等待输入；它不表示任务完成百分比。",
  "launch.taskIncomplete": (n: number) => `请补充任务 ${n} 的名称和任务说明。`,
  "launch.batchResult": "每项任务将启动一个可独立交互的子会话。",
  ...
  "settings.composerChip.collaboration": "协作模式",
  "settings.composerChip.permission": "权限模式",
  ...
  "settings.fontUnconfirmed": "无法确认此字体是否可用。",
  ...
  "settings.scNewAgentSession": "新建智能体会话",
  ...
  "tree.openSplitRight": "在右侧分屏打开",
  "tree.openSplitDown": "在下方分屏打开",
  "tree.openInFocusedPane": "在当前分屏打开",
  "tree.tileSelected": "平铺选中会话",
  "tree.tileSelectedTooMany": "平铺选中会话（最多 4 个）",
  "tree.forkSession": "Fork 会话",
  "tree.exportSession": "导出会话…",
  "tree.sessionInfo": "会话信息",
  "tree.groupInfo": "分组信息",
  "tree.collectionInfo": "集合信息",
  "tree.projectInfo": "项目信息",
  "info.branch": "分支",
  "info.path": "路径",
  "info.recentCommits": "最近提交",
  "info.noCommits": "无提交",
  "tree.killProcess": "结束进程",
  "tree.killProcessConfirm": (name: string) => `结束“${name}”的进程？当前任务将中断，已保存的会话记录和文件会保留。`,
  ...
  "importSessions.description": "查找工作目录与本项目一致的 Codex、Claude、OpenCode 和 Kiro 历史会话。选择会话并将其加入项目后，即可打开并继续对话。目前仅支持查看纯文本的 Kiro 历史记录。",
  ...
  "agentInstall.pathLabel": "可执行文件路径",
  "agentInstall.pathPlaceholder": (bin: string) => `~/.local/bin/${bin}`,
  "agentInstall.pathHint": "已经装在 PATH 之外？填写可执行文件的完整路径。",
  "agentInstall.pathSave": "使用该路径",
  "agentInstall.pathBrowse": "浏览…",
  ...
  "doc.source": "源码模式",
  "doc.compare": "对照模式",
  "doc.editorLoadFailed": "Markdown 编辑器加载失败。",
  "doc.imageOnly": "此处只能插入图片文件。",
  ...
  "panel.collapseSection": "折叠该区域",
  "panel.expandSection": "展开该区域",
  ...
  "transfer.downloading": "正在下载…", // Downloading…
  "transfer.savedToDownloads": "已保存到下载文件夹", // Saved to Downloads
  ...
  "login.passwordSaveFailed": "已连接，但密码未能保存到手机，请重试。",
  ...
  // ── Mobile ──
  "agentPicker.title": "新建智能体会话",
  "agentPicker.search": "搜索智能体和预设",
  "agentPicker.sibling": "同级",
  "agentPicker.child": "子会话",
  "agentPicker.targetSibling": (session: string, location: string) => `在 ${location} 中创建与“${session}”同级的会话。`,
  "agentPicker.targetChild": (session: string, location: string) => `在 ${location} 的“${session}”下创建子会话。`,
  "agentPicker.targetProject": (project: string) => `在 ${project} 中创建会话。`,
  "agentPicker.noProject": "请选择或打开项目，然后创建智能体会话。",
  "agentPicker.selectProject": "选择项目",
  "agentPicker.recent": "上次使用",
  "agentPicker.noResults": (query: string) => `没有与“${query}”匹配的智能体或预设。`,
  "agentPicker.loadFailed": "无法加载智能体和预设，请重试。",
  "agentPicker.placementHint": "在搜索框中按 Tab 切换层级，↑/↓ 选择，Enter 创建；按 Esc 关闭。",
  "agentPicker.invalidTarget": "所选分组或父会话已不可用，请重新选择项目。",
  "agentPicker.creating": "正在创建…",
  "mobile.backConnections": "返回连接列表",
  "mobile.loadSlow": "加载耗时超过预期，可重试或返回连接列表。",
  "mobile.connectionUnavailable": "连接暂不可用",
  "mobile.pushTitle": "任务通知",
  "mobile.pushHint": "通知显示会话名称和简短回复摘要，支持前台、后台及锁屏提醒。velaterm.com 和推送服务会接收这些文字，不会接收连接密码或 SSH 私钥。",
  "mobile.pushEnable": "开启通知",
  "mobile.pushDisable": "关闭通知",
  "mobile.pushTest": "发送测试通知",
  "mobile.pushTestSent": "测试通知已加入队列，请查看系统通知中心。",
  "mobile.pushDisabled": "后台通知未开启。",
  "mobile.pushEnabled": "后台通知已开启。",
  "mobile.pushNotConfigured": "此构建尚未配置推送通道。",
  "mobile.pushDenied": "请在系统设置中允许通知。",
  "mobile.pushRegistrationFailed": "设备注册失败，请重试。",
  "mobile.pushRelayUnavailable": "通知中转服务暂时不可用，请重试。",
  "mobile.pushHostUnavailable": "远端尚未启用后台通知，请更新远端并重新连接。",
  "mobile.pushDisclosure": "后台通知使用个推和设备厂商的推送服务。为投递通知，这些服务会处理设备标识、网络信息、会话名称和简短回复摘要，不会接收连接密码或 SSH 私钥。",
  "mobile.pushConnectHint": "开启后，请分别打开需要接收提醒的连接，完成通知订阅。",
  "mobile.pushTarget": "接收测试通知的连接",
  "mobile.copyConnection": "复制并编辑",
  "mobile.copyConnectionHint": "以此连接为基础修改配置，安全沿用已保存的凭据。原连接保持不变；配置完全相同时，复用现有连接。",
  "mobile.copyConnectionReused": "此配置已保存，已保留现有连接。",
  "mobile.inputOptions": "输入选项",
  "mobile.connections": "连接管理",
  "mobile.more": "更多操作",
  "mobile.toDesktop": "切换到桌面版",
  "mobile.empty1": "暂无会话。",
  "mobile.noMatch": "没有匹配的会话",
  "mobile.empty2": "在桌面应用或电脑浏览器中创建会话后，此处会自动显示。",
  "mobile.back": "‹ 返回",
  "mobile.selCopy": "复制",
  "mobile.selCancel": "取消",

  // ── Mobile connection client (apps/mobile start page) ──
  "mobile.phaseConnecting": "正在通过 SSH 连接…",
  "mobile.phaseConfirming": "请确认主机指纹",
  "mobile.phasePreparing": "正在检查或准备远端服务…",
  "mobile.phaseForwarding": "正在建立 SSH 隧道…",
  "mobile.phaseReady": "已连接",
  "mobile.phaseDisconnected": "连接已断开",
  "mobile.phaseError": "连接失败",
  "mobile.accountAndLogin": "账号与登录",
  "mobile.connectionService": "连接服务不可用",
  "mobile.nativeOnly": "连接功能仅限 iOS 或 Android 应用使用，浏览器仅支持预览界面。",
  "mobile.managedRemotely": "项目与会话由远端服务管理。",
  "mobile.buildInfo": (version: string, time: string) => `应用 v${version} · 构建时间 ${time}`,
  "mobile.myDevices": "我的设备",
  "mobile.account": "账号",
  "mobile.signedInHint": "已登录，可查看此账号下设备共享的工作空间、项目和会话。",
  "mobile.manageAccount": "管理账号",
  "mobile.signOut": "退出登录",
  "mobile.viewMyDevices": "查看我的设备",
  "mobile.noDevices": "尚无设备登录此账号。",
  "mobile.online": "在线",
  "mobile.offline": "离线",
  "mobile.deviceNotSharing": "此设备尚未共享内容。",
  "mobile.scopeMachine": "整个工作空间",
  "mobile.scopeProject": "项目",
  "mobile.scopeSession": "会话",
  "mobile.sharingNotReady": "共享内容尚未就绪，请在该设备上检查共享设置。",
  "mobile.deviceOffline": "设备已离线，请在该设备上打开 VelaTerm 并保持网络连接。",
  "mobile.viewShared": "查看共享内容 →",
  "mobile.devicesUnavailable": "无法获取设备列表，请重试。",
  "mobile.accountUnavailable": "无法获取账号状态，请检查网络连接后重试。",
  "mobile.signInTitle": "登录 VelaTerm",
  "mobile.signInHint": "使用邮箱和密码或第三方账号登录，查看你的设备和共享内容。",
  "mobile.signIn": "登录",
  "mobile.checkSignIn": "检查登录状态",
  "mobile.waitingSignIn": "正在等待登录确认…",
  "mobile.workspaceTitle": "你的工作空间",
  "mobile.workspaceHint": "连接远程主机，继续工作。",
  "mobile.newSsh": "＋ SSH 连接",
  "mobile.newUrl": "＋ URL 连接",
  "mobile.scanToConnect": "扫码连接",
  "mobile.noConnections": "尚未保存连接。可添加 SSH 或 URL 连接，或打开“我的设备”查看同账号设备共享的内容。",
  "mobile.tapToConnect": "点击连接 →",
  "mobile.webPasswordSaved": "服务访问密码已保存",
  "mobile.deleteConnectionTitle": "删除连接",
  "mobile.deleteConnectionConfirm": (name: string) => `删除“${name}”及其保存的凭据？远端项目不会被删除。`,
  "mobile.connectionMissing": "连接不存在",
  "mobile.editConnection": "编辑连接",
  "mobile.addSshHost": "添加 SSH 连接",
  "mobile.addUrlConnection": "添加 URL 连接",
  "mobile.connectionName": "连接名称",
  "mobile.serviceUrl": "服务地址",
  "mobile.scanToFill": "扫码填写",
  "mobile.openingCamera": "正在打开相机…",
  "mobile.scanCancelled": "已取消扫码",
  "mobile.scanDone": "已识别服务地址，请确认后保存并连接。",
  "mobile.scanNativeOnly": "扫码功能仅限 iOS 或 Android 应用使用。",
  "mobile.webPasswordOptional": "服务访问密码（可选）",
  "mobile.keepPassword": "留空保留当前密码",
  "mobile.webPasswordLater": "也可在连接后输入",
  "mobile.webPasswordSavedHint": "服务访问密码已保存，重新连接时会自动使用。留空不会清除已保存的密码。",
  "mobile.webPasswordStorageHint": "密码保存在手机安全存储中，也可在连接后输入密码时选择记住密码。",
  "mobile.sshHost": "SSH 主机",
  "mobile.sshHostPlaceholder": "主机名或 IP 地址",
  "mobile.sshPort": "SSH 端口",
  "mobile.username": "用户名",
  "mobile.authMethod": "认证方式",
  "mobile.authPassword": "密码",
  "mobile.authKeyAndroid": "私钥（OpenSSH Ed25519 / RSA）",
  "mobile.authKey": "私钥（OpenSSH Ed25519）",
  "mobile.sshPassword": "SSH 密码",
  "mobile.privateKey": "私钥",
  "mobile.keepPrivateKey": "留空保留已保存的私钥",
  "mobile.pastePrivateKey": "粘贴 OpenSSH 私钥",
  "mobile.passphraseOptional": "私钥口令（可选）",
  "mobile.keepPassphrase": "留空保留当前口令",
  "mobile.sshSecretSavedHint": "SSH 凭据已保存在手机安全存储中，编辑时留空即可保留。",
  "mobile.remoteService": "远端服务",
  "mobile.serviceAuto": "自动查找 VelaTerm 服务",
  "mobile.serviceManual": "指定已有服务端口",
  "mobile.remotePort": "远端回环 HTTP 服务端口",
  "mobile.webPasswordAutoHint": "服务访问密码已保存，重新连接时会自动使用。",
  "mobile.prepareService": "没有可用服务时，下载并启动 VelaTerm 服务",
  "mobile.prepareServiceHint": "自动准备会在远端主机的 ~/.velaterm/ 中写入经过签名校验的程序、配置和日志，并让服务持续运行。此过程需要 Python 3 和支持 Ed25519 的 OpenSSL；复用已有服务或指定其端口不需要这些工具。",
  "mobile.saveConnection": "保存连接",
  "mobile.saveAndConnect": "保存并连接",
  "mobile.loginOpening": "正在浏览器中打开登录页面…",
  "mobile.loginFinishInBrowser": "请在浏览器窗口中完成登录，然后返回应用。",
  "mobile.loginChecking": "正在检查登录状态…",
  "mobile.loginSuccess": "登录成功。",
  "mobile.loginWaiting": "正在等待登录确认。完成后将自动更新账号和设备列表。",
  "mobile.loginExpired": "登录请求已过期，请重新登录。",
  "mobile.loginRetrying": "暂时无法连接账号服务，正在重试。无需重新登录。",

  // The account service is temporarily unreachable. Retrying. You do not need to sign in again.
  ...
  "session.terminalViewHint": "点击这里可切换回终端视图。",
  ...
  "chat.mode.plan": "计划模式",
  "chat.permissionRestart.unconfirmed": "连接已断开，尚无法确认权限是否切换成功。请重新连接后查看会话的当前权限。",
  "permission.stateUnavailable": "权限状态不可用",
  "permission.currentUnknown": "当前权限未确认",
  "permission.notRunning": "未运行",
  "permission.applied": "已生效",
  "permission.nextTurn": "下一条消息生效",
  "permission.restart": "重启会话后生效",
  "permission.nextStart": "下次启动生效",
  "permission.defaultHint": "新建会话的默认权限。已有会话保留各自的权限设置。",
  "chat.permissionRestart.title": "重启并启用全部放行？",
  "chat.permissionRestart.body": "启用全部放行需要重启 Claude。重启会中断当前回复，聊天记录会保留。切换成功后，将跳过权限确认。",
  "chat.permissionRestart.confirm": "重启并应用",
  "chat.permissionRestart.busy": "正在重启…",
  "chat.permissionRestart.failed": (detail: string) => "权限切换失败，已保留原权限模式。" + detail,
  "chat.permissionRestart.tasks": "请先处理或移除排队消息，并停止后台任务，再重启。",
  "chat.permissionRestart.stale": "会话进程已发生变化，请重新选择全部放行。",
  "chat.permissionRestart.noHistory": "尚无法续接当前会话，请等待会话初始化后重试。",
  ...
  "chat.shell.title": "Shell 命令",
  "chat.shell.running": "运行中…",
  "chat.shell.cancel": "取消",
  "chat.shell.cancelled": "已取消",
  "chat.shell.exitCode": (code: number) => `退出码 ${code}`,
  "chat.shell.stderr": "stderr",
  "chat.shell.truncated": "较早的输出已截断，仅保留最新部分。",
  "chat.shell.outputIncomplete": "部分输出流尚未关闭时，已停止采集，输出可能不完整。",
  "chat.shell.emptyCommand": "在 ! 后输入要在 Shell 中执行的命令。",
  "chat.shell.noImages": "Shell 命令不能附带图片。请移除附件，或将其作为消息发送。",
  "chat.shell.alreadyRunning": "此对话中仍有 Shell 命令正在运行。请取消该命令，或等待执行结束。",
  ...
  "chat.rewind.edit": "编辑",
  "chat.rewind.editSend": "确认并重新发送",
  "chat.rewind.editConfirm": "删除并重新发送",
  "chat.rewind.editWarning": "原消息及其后的全部消息将被永久删除，随后从这里发送修改后的内容。已修改的文件不会恢复。",
  "chat.rewind.inactive": "会话进程尚未启动，启动后可使用这些操作。",
  "chat.rewind.unsupported": "当前连接的 Agent 暂未提供此操作。",
  ...
  "chat.turnFold.hide": "隐藏过程",
  "chat.turnFold.show": (n: number) => `显示过程（${n} 步）`,
  "chat.turnFold.hideAll": "隐藏全部过程",
  "chat.turnFold.showAll": "显示全部过程",
  ...
  "chat.auth.logoutConfirm": (provider: string) => `确定登出当前主机上的 ${provider} 账号吗？这将清除共享的账号凭据，并影响使用这些凭据的其他会话。会话记录会保留。`,
  "chat.auth.signingOut": "正在登出…",
  "chat.auth.signedOut": (provider: string) => `已登出 ${provider}，登录后可继续当前会话。`,
  "chat.auth.logoutFailed": "无法确认登出结果，请重试。",
  "chat.auth.wait": "请等待当前任务结束后再切换账号。",
  "chat.auth.title": (provider: string) => `${provider} 账号`,
  "chat.auth.start": "重新登录",
  "chat.auth.required": (provider: string) => `${provider} 登录状态已失效，请重新登录后继续。`,
  "chat.auth.starting": "正在准备登录…",
  "chat.auth.pending": "请打开授权页面并输入此验证码。登录完成后，此处会自动更新。",
  "chat.auth.success": "登录成功，可以发送消息继续当前会话。",
  "chat.auth.failed": "未能完成登录，请重试。请确认已在 ChatGPT 中启用设备码认证，且当前 Codex CLI 支持此功能。",
  "chat.auth.canceled": "已取消登录，可随时重试。",
  "chat.auth.scope": (provider: string) => `登录将更新当前主机使用的 ${provider} 账号，共用这份凭据的其他会话也将使用该账号。`,
  "chat.auth.canceling": "正在取消登录…",
  "chat.auth.submitting": "正在验证授权码…",
  "chat.auth.claude.pending": "打开授权页面并登录，然后将页面显示的完整授权码粘贴到下方。",
  "chat.auth.claude.failed": "未能完成登录，请重试，并确认当前 Claude CLI 支持账号授权。",
  "chat.auth.claude.code": "授权码",
  "chat.auth.claude.submit": "提交授权码",
  "chat.auth.claude.invalidCode": "请粘贴本次授权页面提供的完整授权码，包括 # 后面的内容。",
  "chat.auth.claude.externalAuth": "API 密钥及其他已配置的认证方式不会更改。",
  "chat.auth.open": "打开授权页面",
  "chat.resetCredits.label": (n: string) => `重置券：${n} 张`,
  "chat.resetCredits.title": "Codex 额度重置券",
  "chat.resetCredits.unknown": "暂无法获取重置券数量。",
  "chat.resetCredits.confirm": "使用一张重置券，重置符合条件的 Codex 用量额度。此操作无法撤销。",
  "chat.resetCredits.reset": "额度已重置。",
  "chat.resetCredits.alreadyRedeemed": "此请求此前已成功执行。",
  "chat.resetCredits.nothingToReset": "当前没有符合重置条件的用量额度。",
  "chat.resetCredits.noCredit": "没有可用的重置券。",
  "chat.resetCredits.error": "请求失败或暂无法获取最新余额。请刷新余额，或重试尚未确认的重置请求。",
  "chat.resetCredits.busy": "处理中…",
  "chat.resetCredits.retry": "重试重置",
  "chat.resetCredits.use": "使用一张",
  "chat.resetCredits.refresh": "刷新",
  ...
  "chat.autoContinue.fiveHour": (time: string) => `已达到 5 小时用量上限，将于 ${time} 自动继续任务。`,
  "chat.autoContinue.weekly": (time: string) => `已达到每周用量上限，将于 ${time} 自动继续任务。`,
  "chat.autoContinue.generic": (time: string) => `已达到用量上限，将于 ${time} 自动继续任务。`,
  "chat.autoContinue.unknownReset": "已达到用量上限。无法获取重置时间，任务不会自动继续。",
  "chat.autoContinue.repeated": "再次达到用量上限，任务不再自动继续。",
  "chat.autoContinue.failed": "任务未能自动继续，发送消息即可继续。",
  ...
  "chat.tasks.stop": "停止",
  "chat.chipAgentNotRunning": "智能体进程未运行。发送消息即可启动。",
  "chat.tasks.open": "打开任务",
  "chat.tasks.tabTooltip": "后台任务",
  "chat.tasks.status.running": "运行中",
  "chat.tasks.status.completed": "已完成",
  "chat.tasks.status.failed": "失败",
  "chat.tasks.status.canceled": "已停止",
  "chat.tasks.status.ended": "已结束",
  "chat.tasks.stale": "智能体已不再报告此任务",
  "chat.tasks.elapsed": "已用时间",
  "chat.tasks.tokens": "Token 数",
  "chat.tasks.toolUses": "工具调用次数",
  "chat.tasks.lastTool": "最近上报的工具",
  "chat.tasks.lastUpdatedAgent": "最近上报的智能体",
  "chat.tasks.started": "开始时间",
  ...
  "chat.tasks.agentState.start": "运行中",
  ...
  "settings.completionMode": "命令补全提示",
  "settings.completionAuto": "自动提示",
  "settings.completionTab": "按 Tab 提示",
  "settings.completionOff": "完全关闭",
  "settings.completionUnavailable": "无法读取或保存设置。",
  "settings.completionHint": "适用于新建的 Zsh、Bash 4+、Fish 和 PowerShell 终端。CMD 保留原生 Tab 行为。Tab 填入选中的候选项；Enter 直接执行当前命令，不应用候选项。",
  ...
  "mobile.native.trustTitle": "确认远端指纹",
  "mobile.native.trustChangedTitle": "远端指纹已变更",
  "mobile.native.trustBody": "{identity}\n\n{fingerprint}\n\n继续前，请与主机管理员核对此指纹。",
  "mobile.native.trustChangedBody": "{identity}\n\n{fingerprint}\n\n此指纹与此前信任的指纹不同。继续前，请与主机管理员核对。此前信任的指纹将被替换。",
  "mobile.native.trustAccept": "信任并继续",
  "mobile.native.tlsIdentity": "HTTPS 证书 · {identity}",
  "mobile.native.ok": "确定",
  "mobile.native.reconnect": "重新连接",
  "mobile.native.switchConnection": "切换连接",
  "mobile.native.currentServer": "当前服务器",
  "mobile.native.navigationBlocked": "已阻止跳转到当前服务以外的地址：{host}",
  "mobile.native.pageUnavailable": "远端页面暂时不可用（HTTP {code}）。请重试或返回连接列表。",
  "mobile.native.pageLoadFailed": "无法加载远端页面。请检查网络后重试，或返回连接列表。",
  "mobile.native.pageLoadFailedReason": "无法加载远端页面。请检查网络后重试，或返回连接列表。\n\n{reason}\n{domain} {code}",
  "mobile.native.pageTerminated": "页面已停止运行。请重新连接或返回连接列表。",
  "mobile.native.certificateRejected": "未能验证远端证书。请重新连接或返回连接列表。",
  "mobile.native.webViewOutdated": "请更新 Android System WebView 后重试，或返回连接列表。",
  "mobile.native.downloadFailedTitle": "下载失败",
  "mobile.native.downloadRetry": "下载失败，请重试。",
  "mobile.native.downloadTooLarge": "移动端目前支持导出不超过 64 MB 的文件。",
  "mobile.native.downloadFileFailed": "文件下载失败，请重试。",
  "mobile.native.downloadCreateFailed": "无法创建下载文件。",
  "mobile.native.saveLocationFailed": "无法打开保存位置。",
  "mobile.native.fileSaved": "文件已保存",
  "mobile.native.fileSaveFailed": "文件保存失败，请重试。",
  "mobile.native.savePickerFailed": "无法打开文件保存对话框。",
  "mobile.native.scanHint": "将摄像头对准 URL 二维码",
  "mobile.native.scanPrompt": "扫描服务地址二维码。按返回键取消。",
  "mobile.native.scanBusy": "正在扫码，请先关闭当前扫码窗口。",
  "mobile.native.scanUnavailable": "无法打开扫码窗口，请返回连接列表后重试。",
  "mobile.native.scannerNotReady": "扫码功能尚未就绪。",
  "mobile.native.scanCancelled": "扫码已取消。",
  "mobile.native.cameraPermissionDenied": "尚未允许访问相机。请在系统设置中允许 VelaTerm 使用相机。",
  "mobile.native.cameraUnavailable": "无法使用相机，请检查设备和相机权限。",
  "mobile.native.cameraBusy": "相机不可用，请关闭其他使用相机的应用后重试。",
  "mobile.native.qrOutputUnavailable": "此设备无法识别二维码。",
  "mobile.native.qrTypeUnavailable": "此设备不支持扫描二维码。",
  "mobile.native.qrTooLong": "二维码中的 URL 过长。",
  "mobile.native.qrInvalid": "二维码中没有有效的服务地址。请扫描不含用户名或密码的 HTTPS URL。",
  "mobile.native.urlConnectionName": "URL 连接",
  "mobile.native.keychainReadFailed": "无法读取系统钥匙串（{code}）。",
  "mobile.native.keychainWriteFailed": "无法保存到系统钥匙串（{code}）。",
  "mobile.native.secureStorageWriteFailed": "无法保存到安全存储。",
  "mobile.native.hostKeyUnreadable": "无法读取主机公钥。",
  "mobile.native.portRange": "端口必须介于 1 和 65535 之间。",
  "mobile.native.addressInvalid": "请输入不含用户名或密码的 HTTP 或 HTTPS 地址。",
  "mobile.native.httpsRequired": "URL 连接请使用 HTTPS；HTTP 仅允许用于本机 SSH 隧道。",
  "mobile.native.nameRequired": "请输入连接名称。",
  "mobile.native.sshHostInvalid": "请输入有效的 SSH 主机和用户名。",
  "mobile.native.sshHostNameInvalid": "请输入有效的 SSH 主机名。",
  "mobile.native.sshUsernameRequired": "请输入 SSH 用户名。",
  "mobile.native.sshCredentialsRequired": "请输入 SSH 密码或私钥。",
  "mobile.native.privateKeyRequired": "请输入私钥。",
  "mobile.native.sshPasswordRequired": "请输入 SSH 密码。",
  "mobile.native.serviceModeRequired": "请选择服务连接方式。",
  "mobile.native.modeUnsupported": "不支持此连接方式。",
  "mobile.native.connectionMissing": "此连接不存在。",
  "mobile.native.connectionConfigMissing": "缺少连接配置。",
  "mobile.native.connectionIdMissing": "缺少连接 ID。",
  "mobile.native.accountServiceUnavailable": "账号服务不可用，请重试。",
  "mobile.native.loginRequestExpired": "登录请求已过期，请重新登录。",
  "mobile.native.sessionExpired": "登录状态已过期，请重新登录。",
  "mobile.native.accountWindowBusy": "无法打开账号窗口，请先关闭当前窗口。",
  "mobile.native.loginResponseInvalid": "登录响应无效。",
  "mobile.native.loginRestart": "请重新发起登录。",
  "mobile.native.signInFirst": "请先登录。",
  "mobile.native.deviceInvalid": "设备 ID 无效。",
  "mobile.native.grantInvalid": "共享范围无效。",
  "mobile.native.connectResponseInvalid": "连接响应无效。",
  "mobile.native.remoteWindowFailed": "无法打开远端窗口。",
  "mobile.native.accountActionInvalid": "账号操作无效。",
  "mobile.native.accountAddressInvalid": "账号服务 URL 无效。",
  "mobile.native.loginRequestInvalid": "登录请求无效。",
  "mobile.native.loginStateUpdateFailed": "无法更新登录状态。",
  "mobile.native.loginFailed": "登录失败。",
  "mobile.native.connectionFailed": "连接失败。",
  "mobile.native.resourceMissing": "缺少远端初始化所需的资源。",
  "mobile.native.hostKeyRejected": "未信任 SSH 主机指纹。",
  "mobile.native.rsaUnsupported": "iOS SSH 库不支持 RSA SHA-2 认证。请使用 Ed25519 私钥或密码。",
  "mobile.native.privateKeyUnreadable": "无法读取私钥，请检查密钥口令。支持 OpenSSH Ed25519 密钥；加密密钥须使用 AES-CTR。",
  "mobile.native.connectionCancelled": "连接已取消。",
  "mobile.native.sourceConnectionMissing": "源连接已不可用，请返回连接列表后重试。",
  "mobile.native.pythonRequired": "远端初始化需要 Python 3，也可指定已运行服务的端口。",
  "mobile.native.localPortFailed": "无法分配 SSH 本地端口。",
  "mobile.native.healthCheckFailed": "远端服务未通过健康检查。",
  "mobile.native.connectionClosed": "连接已关闭。",
  "mobile.native.responseTooLarge": "远端响应过大。",
  "mobile.native.cameraUsageDescription": "VelaTerm 使用相机扫描服务地址二维码。",
  "mobile.native.localNetworkUsageDescription": "VelaTerm 连接局域网中的 VelaTerm 服务和 SSH 主机。",


  "term.runs.label": "后台命令",
  "term.runs.elapsed": (time) => `已运行 ${time}`,
  "term.runs.viewLog": "日志",
  "term.runs.stop": "停止",
  "term.runs.confirmStop": "确认停止",
  "term.runs.stopFailed": "无法停止",
  "term.runs.logTitle": (label) => `日志：${label}`,
  "term.runs.logRunning": "运行中",
  "term.runs.logFinished": (code) => `已结束，退出码 ${code}`,
  "term.runs.logEnded": "已结束",
  "term.runs.logEmpty": "暂无输出",
};
