...
const zhCN: typeof en = {
  "tree.newPlanExecuteSession": "新建规划与执行会话…",
  ...
  "mobile.loadSlow": "加载时间较长，你可以重试或返回连接列表。",
  ...
  "mobile.pushTarget": "测试连接",
  "mobile.copyConnection": "复制并编辑",
  "mobile.copyConnectionHint": "以此连接为基础修改配置，安全继承已保存的凭据。原连接保持不变；配置完全相同时，仍只保留一份。",
  ...
  "mobile.accountUnavailable": "无法获取账号状态，请检查网络后重试。",
  "mobile.signInTitle": "登录 VelaTerm",
  "mobile.signInHint": "通过邮箱密码或第三方账号登录，查看你的设备和共享内容。",
  "mobile.signIn": "登录",
  "mobile.checkSignIn": "检查登录结果",
  "mobile.waitingSignIn": "正在等待登录确认…",
  "mobile.workspaceTitle": "你的工作空间",
  "mobile.workspaceHint": "连接远程主机，继续项目中的工作。",
  "mobile.newSsh": "＋ SSH 连接",
  "mobile.newUrl": "＋ URL 连接",
  "mobile.remote": "Remote",
  "mobile.scanToConnect": "扫码连接",
  "mobile.noConnections": "尚未保存连接。可添加 SSH、URL 连接，或通过 Remote 查看同账号设备的共享内容。",
  "mobile.tapToConnect": "点击连接 →",
  "mobile.webPasswordSaved": "服务密码已保存",
  ...
  "mobile.scanNativeOnly": "请在手机 App 中使用相机扫码。",
  "mobile.webPasswordOptional": "服务密码（可选）",
  "mobile.keepPassword": "留空保留原密码",
  "mobile.webPasswordLater": "也可进入网页后登录",
  "mobile.webPasswordSavedHint": "服务密码已保存，重新连接时会自动使用。留空不会清除已保存的密码。",
  "mobile.webPasswordStorageHint": "密码保存在手机安全存储中，也可在登录时选择记住密码。",
  ...
  "mobile.webPasswordAutoHint": "服务密码已保存，重新连接时会自动使用。",
  "mobile.prepareService": "没有可用服务时，允许下载并启动 VelaTerm 服务",
  "mobile.prepareServiceHint": "自动准备会在远端 ~/.velaterm/ 写入经过签名校验的程序、配置和日志，并保留运行服务。需要 Python 3 和支持 Ed25519 的 OpenSSL；复用已有服务或指定端口不需要安装这些工具。",
  "mobile.saveConnection": "保存连接",
  "mobile.saveAndConnect": "保存并连接",
  "mobile.loginOpening": "正在打开登录窗口…",
  "mobile.loginFinishInBrowser": "请在登录窗口中完成登录，然后返回 App。",
  "mobile.loginChecking": "正在检查登录结果…",
  "mobile.loginSuccess": "登录成功。",
  "mobile.loginWaiting": "等待登录确认。完成后将自动更新账号和设备列表。",
  "mobile.loginExpired": "登录请求已失效，请重新登录。",
  ...
  "mobile.native.trustChangedTitle": "远端指纹已变化",
  "mobile.native.trustBody": "{identity}\n\n{fingerprint}\n\n请与主机管理员核对。",
  "mobile.native.trustChangedBody": "{identity}\n\n{fingerprint}\n\n请与主机管理员核对。原有信任记录将被替换。",
  "mobile.native.trustAccept": "确认并信任",
  ...
  "mobile.native.navigationBlocked": "已阻止离开当前服务的导航：{host}",
  ...
  "mobile.native.pageTerminated": "页面已停止运行，请重新连接，或返回连接列表。",
  "mobile.native.certificateRejected": "未能验证远端证书，请重新连接，或返回连接列表。",
  ...
  "mobile.native.downloadTooLarge": "手机文件导出目前支持不超过 64 MB 的文件",
  "mobile.native.downloadFileFailed": "文件未能下载，请重试。",
  ...
  "mobile.native.savePickerFailed": "无法打开文件保存界面",
  "mobile.native.scanHint": "将 URL 二维码放入取景框",
  "mobile.native.scanPrompt": "扫描服务地址二维码；按返回键取消",
  "mobile.native.scanBusy": "正在扫码，请先关闭当前扫码窗口",
  "mobile.native.scanUnavailable": "无法打开扫码窗口，请返回连接首页后重试",
  "mobile.native.scannerNotReady": "扫码功能尚未就绪",
  "mobile.native.scanCancelled": "扫码已取消",
  "mobile.native.cameraPermissionDenied": "相机权限未开启，请在系统设置中允许 VelaTerm 使用相机",
  ...
  "mobile.native.qrTypeUnavailable": "此设备不支持二维码识别",
  "mobile.native.qrTooLong": "二维码中的 URL 过长",
  "mobile.native.qrInvalid": "二维码不是可用的服务地址，请扫描不含账号密码的 HTTPS URL",
  "mobile.native.urlConnectionName": "URL 连接",
  "mobile.native.keychainReadFailed": "无法读取系统钥匙串（{code}）",
  "mobile.native.keychainWriteFailed": "无法保存系统钥匙串（{code}）",
  "mobile.native.secureStorageWriteFailed": "无法保存安全存储",
  "mobile.native.hostKeyUnreadable": "无法读取主机公钥",
  "mobile.native.portRange": "端口必须介于 1 和 65535 之间",
  "mobile.native.addressInvalid": "请输入不含账号密码的 HTTP 或 HTTPS 地址",
  "mobile.native.httpsRequired": "URL 连接请使用 HTTPS；HTTP 仅允许本机 SSH 隧道",
  ...
  "mobile.native.modeUnsupported": "不支持的连接方式",
  "mobile.native.connectionMissing": "连接不存在",
  ...
  "mobile.native.loginRequestExpired": "登录请求已失效，请重新登录。",
  "mobile.native.sessionExpired": "登录已失效，请重新登录。",
  "mobile.native.accountWindowBusy": "无法打开账号窗口，请先关闭当前窗口",
  "mobile.native.loginResponseInvalid": "无效的登录响应",
  "mobile.native.loginRestart": "请重新发起登录",
  "mobile.native.signInFirst": "请先登录",
  "mobile.native.deviceInvalid": "无效的客户端",
  "mobile.native.grantInvalid": "无效的共享范围",
  "mobile.native.connectResponseInvalid": "无效的连接响应",
  "mobile.native.remoteWindowFailed": "无法打开远端窗口",
  "mobile.native.accountActionInvalid": "无效的账号操作",
  "mobile.native.accountAddressInvalid": "无效的账号地址",
  "mobile.native.loginRequestInvalid": "无效的登录请求",
  "mobile.native.loginStateUpdateFailed": "无法更新登录状态",
  "mobile.native.loginFailed": "登录失败",
  "mobile.native.connectionFailed": "连接失败",
  "mobile.native.resourceMissing": "缺少远端准备资源",
  "mobile.native.hostKeyRejected": "未信任 SSH 主机指纹",
  "mobile.native.rsaUnsupported": "当前 iOS SSH 库不支持 RSA SHA-2 认证；请使用 Ed25519 私钥或密码",
  "mobile.native.privateKeyUnreadable": "私钥无法读取；请检查口令。支持 OpenSSH Ed25519，私钥加密格式为 AES-CTR",
  "mobile.native.connectionCancelled": "连接已取消",
  "mobile.native.sourceConnectionMissing": "源连接已不存在，请返回连接列表后重试",
  "mobile.native.pythonRequired": "远端准备需要 Python 3；也可指定已运行服务的端口",
